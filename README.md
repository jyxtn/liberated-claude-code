...
[![Tested with Pytest](https://img.shields.io/badge/testing-Pytest-00c0ff.svg?style=for-the-badge)](https://github.com/jcntrl/liberated-claude-code/actions/workflows/tests.yml)
...
<div align="center">
  <img src="pic.png" alt="Liberated Claude Code in action" width="700">
...
```bash
git clone https://github.com/jcntrl/liberated-claude-code.git
...
```bash
alias claude-pick="/absolute/path/to/liberated-claude-code/claude-pick"
```
...
```bash
uv tool install git+https://github.com/jcntrl/liberated-claude-code.git
fcc-init        # creates ~/.config/liberated-claude-code/.env from the built-in template
```

Edit `~/.config/liberated-claude-code/.env` with your API keys and model names, then:

```bash
liberated-claude-code    # starts the server
```

> To update: `uv tool upgrade liberated-claude-code`
...
```
┌─────────────────┐        ┌──────────────────────┐        ┌──────────────────┐
│  Claude Code    │───────>│  Liberated Claude Code    │───────>│  LLM Provider    │
...
uv tool install "liberated-claude-code[voice_local] @ git+https://github.com/jcntrl/liberated-claude-code.git"
uv tool install "liberated-claude-code[voice] @ git+https://github.com/jcntrl/liberated-claude-code.git"
uv tool install "liberated-claude-code[voice,voice_local] @ git+https://github.com/jcntrl/liberated-claude-code.git"
```
...
- Report bugs or suggest features via [Issues](https://github.com/jcntrl/liberated-claude-code/issues)
